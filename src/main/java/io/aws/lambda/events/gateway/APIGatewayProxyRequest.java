...
public class APIGatewayProxyRequest implements Serializable {
     ...
     * @return
     */
    public APIGatewayProxyRequest withResource(String resource) {
     ...
     */
    public APIGatewayProxyRequest withPath(String path) {
        this.setPath(path);
        return this;
    }
     ...
     */
    public APIGatewayProxyRequest withHttpMethod(String httpMethod) {
        this.setHttpMethod(httpMethod);
        return this;
    }
     ...
     * @return APIGatewayProxyRequestEvent object
     */
    public APIGatewayProxyRequest withHeaders(Map<String, String> headers) {
     ...
     * @return APIGatewayProxyRequestEvent object
     */
    public APIGatewayProxyRequest withMultiValueHeaders(Map<String, List<String>> multiValueHeaders) {
     ...
     * @return APIGatewayProxyRequestEvent
     */
    public APIGatewayProxyRequest withQueryStringParameters(Map<String, String> queryStringParameters) {
     ...
     */
    @Deprecated
    public APIGatewayProxyRequest withQueryStringParamters(Map<String, String> queryStringParameters) {
     ...
     * @return APIGatewayProxyRequestEvent
     */
    public APIGatewayProxyRequest withMultiValueQueryStringParameters(Map<String, List<String>> multiValueQueryStringParameters) {
     ...
     * @return APIGatewayProxyRequestEvent object
     */
    public APIGatewayProxyRequest withPathParameters(Map<String, String> pathParameters) {
     ...
     */
    @Deprecated
    public APIGatewayProxyRequest withPathParamters(Map<String, String> pathParameters) {
     ...
     * @return APIGatewayProxyRequestEvent
     */
    public APIGatewayProxyRequest withStageVariables(Map<String, String> stageVariables) {
     ...
     * @return APIGatewayProxyRequestEvent object
     */
    public APIGatewayProxyRequest withRequestContext(ProxyRequestContext requestContext) {
     ...
     * @return APIGatewayProxyRequestEvent
     */
    public APIGatewayProxyRequest withBody(String body) {
        this.setBody(body);
        return this;
    }
     ...
     * @return APIGatewayProxyRequestEvent
     */
    public APIGatewayProxyRequest withIsBase64Encoded(Boolean isBase64Encoded) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof APIGatewayProxyRequest == false)
            return false;
        APIGatewayProxyRequest other = (APIGatewayProxyRequest) obj;
    ...
    @Override
    public APIGatewayProxyRequest clone() {
        try {
            return (APIGatewayProxyRequest) super.clone();
        } catch (CloneNotSupportedException e) {
            throw new IllegalStateException("Got a CloneNotSupportedException from Object.clone()", e);
        }
    }
