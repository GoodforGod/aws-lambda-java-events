...
public class APIGatewayProxyResponse implements Serializable, Cloneable {
     ...
     */
    public APIGatewayProxyResponse withStatusCode(Integer statusCode) {
     ...
     */
    public APIGatewayProxyResponse withHeaders(Map<String, String> headers) {
     ...
     * @return APIGatewayProxyResponseEvent
     */
    public APIGatewayProxyResponse withMultiValueHeaders(Map<String, List<String>> multiValueHeaders) {
     ...
     */
    public APIGatewayProxyResponse withIsBase64Encoded(Boolean isBase64Encoded) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof APIGatewayProxyResponse == false)
            return false;
    ...
    @Override
    public APIGatewayProxyResponse clone() {
        try {
            return (APIGatewayProxyResponse) super.clone();
