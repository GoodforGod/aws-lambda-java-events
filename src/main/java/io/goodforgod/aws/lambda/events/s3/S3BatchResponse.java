...
public class S3BatchResponse {
    ...
    public enum ResultCode {
        ...
        /**
         * The task completed normally. If you requested a job completion report, the task's result string
         * is included in the report.
         */
        Succeeded,
        /**
         * The task suffered a temporary failure and will be redriven before the job completes. The result
         * string is ignored. If this is the final redrive, the error message is included in the final
         * report.
         */
        TemporaryFailure,
        /**
         * The task suffered a permanent failure. If you requested a job-completion report, the task is
         * marked as Failed and includes the error message string. Result strings from failed tasks are
         * ignored.
         */
        PermanentFailure
    }
